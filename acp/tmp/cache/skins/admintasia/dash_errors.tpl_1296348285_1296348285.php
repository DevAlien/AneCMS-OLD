...
<body id="sidebar-left">
	...
	<span><a href="index.php" title="Layout Options"><?php echo $lang['dashboard'];?></a> > <a href="?m=errors" title="Elements"><?php echo $lang['dashboard_errorslog'];?></a></span>
...
<div class="inner-page-title">
    <h2><?php echo $lang['dashboard_errorslog'];?></h2>
</div>
<div class="hastable">
    <form name="myform" class="pager-form" method="post" action="">
						...
						<th><input type="checkbox" value="check_none" onclick="this.value=check(this.form.list)" class="submit"/></th>
							<th style="width:100px"><?php echo $lang['who'];?></th>
							<th style="width:100px"><?php echo $lang['ip'];?></th>
							<th style="width:100px"><?php echo $lang['when'];?></th>
							<th><?php echo $lang['txt'];?></th>
							<th style="width:64px"><?php echo $lang['options'];?></th> 
						</tr> 
						</thead> 
						<tbody> 
						<?php $counter_errors=0; foreach($var['errors'] as $key => $errors){ $counter_errors++; ?>
			    <tr class="odd">
				<td class="center"><input type="checkbox" value="<?php echo $log['id'];?>" name="list" class="checkbox"/></td> 
                                <td><?php echo $errors['logged'];?></td>
				<td><?php echo $errors['ip'];?></td>
				<td><?php echo date('d-m-Y H:i',$errors['date']);?></td>
