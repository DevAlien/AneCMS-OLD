...
<body id="sidebar-left">
	...
	<span><a href="?p=cfg" title="Layout Options"><?php echo $lang['configuration'];?></a> > <a href="?p=cfg&m=reposerver" title=""><?php echo $lang['insert'];?></a></span>
...
<div class="inner-page-title">
						<h3><?php echo $lang['addrepository'];?></h3>  
<span><?php echo $lang['addrepositorydesc'];?></span>    			
					</div>
...
<div class="hastable">
<div class="inner-page-title">
						<h3><?php echo $lang['reposlist'];?></h3>
						<span><?php echo $lang['reposlistdesc'];?></span>
					</div>	
				<div class="content-box">
					<table cellspacing="0">
						<thead>
							<tr>
								<th><?php echo $lang['serverurl'];?></th>
								<th width="32px"><?php echo $lang['delete'];?></th>
							</tr>
						</thead>
						<tbody>
							<?php $counter_reposervers=0; foreach($var['reposervers'] as $key => $reposervers){ $counter_reposervers++; ?>
				
					<tr>
                                <td><?php echo $reposervers['url'];?></td>
								<td>
								<a class="btn_no_text btn ui-state-default ui-corner-all first" title="<?php echo $lang['delete'];?>" href="?p=cfg&m=reposerver&d=<?php echo $reposervers['id'];?>">
