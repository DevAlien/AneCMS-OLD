...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/test/ANECMS/system/pages/bootstrap.css.php?system/js/jquery.jgrowl.css" media="screen"/> <script type="text/javascript" src="http://localhost/test/ANECMS/system/pages/bootstrap.js.php?system/js/jquery-1.3.2.min.js|system/js/jquery.jgrowl_minimized.js|system/js/admin.js"></script>
...
<body id="sidebar-left">
	...
	<span><a href="?p=cfg" title="Layout Options">Widgets</a> > <a href="?p=cfg&m=reposerver" title=""><?php echo $lang['insert'];?></a></span>
...
<div class="inner-page-title">
						<h3><?php echo $lang['tplselect'];?></h3>	
<span><?php echo $lang['tplselectdesc'];?></span>						
					</div>
							...
							<li>
								...
								<div>
									<select tabindex="4" class="field select small" name="templatename" id="templatename" onChange="selecttpl()">
										...
										<?php $counter_templates=0; foreach($var['templates'] as $key => $templates){ $counter_templates++; ?>
											<option value="<?php echo $templates['name'];?>"><?php echo $templates['name'];?></option>
										<?php } ?>
									</select>
								</div>
							</li>
